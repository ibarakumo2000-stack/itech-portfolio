    ...
    <section id="contact" className="py-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Left Column: Direct Call & WhatsApp Buttons */}
                ...
                {emailSuccess ? (
                  ...
                  <form className="space-y-5" noValidate>
                    ...
                    <div className="space-y-1.5">
                      <label htmlFor="sec-name" className="block text-xs font-mono uppercase tracking-wider text-slate-300 font-semibold">
                    ...
                    {/* Email Field */}
                    <div className="space-y-1.5">
                      <label htmlFor="sec-email" className="block text-xs font-mono uppercase tracking-wider text-slate-300 font-semibold">
                    ...
                    {/* Message Field */}
                    <div className="space-y-1.5">
                      <label htmlFor="sec-message" className="block text-xs font-mono uppercase tracking-wider text-slate-300 font-semibold">
